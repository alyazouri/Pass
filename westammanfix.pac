  "185.253.112.0/22","188.123.160.0/19","188.247.64.0/19","193.17.53.0/24",
  "193.108.134.0/23","193.111.29.0/24","193.188.64.0/19","193.189.148.0/24",
  "193.203.24.0/23","193.203.110.0/23","194.104.95.0/24","194.110.236.0/24",
  "194.165.128.0/19","195.18.9.0/24","212.34.0.0/19","212.35.64.0/19",
  "212.118.0.0/19","213.139.32.0/19","213.186.160.0/19","217.23.32.0/20",
  "217.29.240.0/20","217.144.0.0/20"
];

var JORDAN_IPV6_PFX = [
  "2001:32c0","2001:67c:2124","2a00:18d0","2a00:18d8","2a00:4620",
  "2a00:76e0","2a00:b860","2a00:caa0","2a01:1d0","2a01:9700",
  "2a01:e240","2a01:ee40","2a02:9c0","2a02:2558","2a02:25d8",
  "2a02:5b60","2a02:c040","2a02:e680","2a02:f0c0","2a03:6b00",
  "2a03:6d00","2a03:b640","2a04:6200","2a05:74c0","2a05:7500",
  "2a06:9bc0","2a06:bd80","2a07:140","2a0a:2740","2a0c:39c0",
  "2a0d:cf40","2a10:1100","2a10:9740","2a10:d800","2a11:d180",
  "2a13:1f00","2a13:5c00","2a13:8d40","2a14:1a40","2a14:2840"
];

// ─────────────────────────────────────────────
//  §8-B  WEST AMMAN / UPSCALE RANGES
//  عبدون — الصويفية — خلدا — دير غبار
//  الدوار الرابع ← السابع — تلاع العلي
//  شميساني — الجبيهة — أم أذينة
// ─────────────────────────────────────────────
var WEST_AMMAN_IPV4_CIDR = [
  // Orange Jordan (JTC) — غرب عمّان والدوارات
  "176.29.128.0/18","176.29.192.0/19","176.29.224.0/20",
  "176.29.152.0/22","176.29.153.0/24",
  "176.28.128.0/19","176.28.160.0/20",
  "86.108.96.0/20","86.108.112.0/20","86.108.64.0/19",
  // Zain Jordan — الصويفية وخلدا وتلاع العلي
  "82.212.84.0/22","82.212.88.0/21","82.212.96.0/20",
  "46.185.128.0/19","46.185.130.0/23","46.185.132.0/22",
  // Umniah — شميساني وأم أذينة والجبيهة
  "37.123.64.0/20","37.123.80.0/21","37.202.64.0/20",
  // Batelco / Mada
  "94.142.32.0/21","94.142.40.0/22",
  "94.249.0.0/19","94.249.32.0/20",
  // FTTH عبدون / دير غبار
  "5.45.128.0/21","5.45.136.0/22"
];

// ─────────────────────────────────────────────
//  §8-C  FAST-PATH PREFIXES
// ─────────────────────────────────────────────
var KNOWN_JO_PREFIXES = [
  "46.185.131","176.29.153","212.35.66","86.108.",
  "92.253.","94.249.","82.212.84","81.28.11",
  "176.29.1","176.28.","94.142.","46.185.13","213.139."
];

var KNOWN_WA_PREFIXES = [
  "176.29.153","176.29.152","176.29.128","176.29.192",
  "82.212.84","82.212.88","82.212.96",
  "46.185.130","46.185.131","46.185.132",
  "86.108.96","86.108.112","86.108.64",
  "37.123.64","37.123.80","94.142.32","94.249."
];
...
function isIP(h)     { return isIPv4(h) || isIPv6(h); }
...
function isInCIDRv4(ip, cidr) {
  var p = cidr.split("/"), mask = cidrMask(parseInt(p[1],10));
  return (ipToInt(ip) & mask) === (ipToInt(p[0]) & mask);
}

function isInIPv6Prefix(ip, list) {
...
function isJordanIP(ip) {
  if (!ip) return false;
  if (isIPv6(ip)) return isInIPv6Prefix(ip, JORDAN_IPV6_PFX);
  if (isIPv4(ip)) {
...
function isWestAmmanIP(ip) {
  if (!ip || !isIPv4(ip)) return false;
  for (var f = 0; f < KNOWN_WA_PREFIXES.length; f++)
    if (ip.indexOf(KNOWN_WA_PREFIXES[f]) === 0) return true;
  for (var c = 0; c < WEST_AMMAN_IPV4_CIDR.length; c++)
    if (isInCIDRv4(ip, WEST_AMMAN_IPV4_CIDR[c])) return true;
  return false;
}
...
function firstWestAmmanIP(ips) {
  for (var i = 0; i < ips.length; i++)
    if (isWestAmmanIP(ips[i])) return ips[i];
  return null;
}
...
function trackDensity(ip) {
  ...
  if (isWestAmmanIP(ip)) SESSION.westAmmanIPSeen++;
}

function westAmmanDensityHigh() {
  if (SESSION.totalIPSeen < 3) return true;
  return (SESSION.westAmmanIPSeen / SESSION.totalIPSeen) >= WEST_AMMAN_DENSITY_MIN;
}
...
function checkExpiry(t) {
  ...
  if (t - SESSION.lastActivity > T_SESSION_IDLE) { resetSession(t); return; }
...
//  §13  PROXY SELECTORS
// ─────────────────────────────────────────────
function lobbyProxy(host)  { return pickAliveProxy(T2_LOBBY, host); }
function matchProxy(host)  { return pickAliveProxy(T1_MATCH, host); }
function socialProxy(host) { return pickAliveProxy(T2_LOBBY, host); }
...
// ── §14-A  MATCH ROUTING ─────────────────────
// القاعدة: match → T1_MATCH أثناء البحث والمطابقة
//          match → DIRECT فقط في IN_GAME (لتقليل الـ latency)
//          لا يوجد return DIRECT لأي سبب آخر
function routeMatchTraffic(host, resolvedIP, score, t) {
  ...
  if (SESSION.state === STATE.IDLE || SESSION.state === STATE.SEARCHING) {
    ...
    if (score >= MATCH_SCORE_FAST) {
      ...
      // IN_GAME → DIRECT لتقليل latency بعد تأكيد المطابقة
      return DIRECT;
    }
    transitionTo(STATE.MATCHED, t);
    return matchProxy(host);
  }
  ...
  // fallback — أي حالة غير متوقعة → T1_MATCH
  return matchProxy(host);
}

// ── §14-B  LOBBY ROUTING ─────────────────────
// القاعدة: جميع طلبات اللوبي → T2_LOBBY دائماً
//          لا يوجد return DIRECT هنا مطلقاً
...
// ── §14-C  WEST AMMAN LOBBY FORCE ────────────
// الأولوية: West Amman → Jordan → Jordan (كل IP أردني يمر)
function jordanLobbyForce(ip, host, t) {
  trackDensity(ip);

  if (isWestAmmanIP(ip)) {
    // IP غرب عمّان → بروكسي فوري
    if (SESSION.state === STATE.IDLE) transitionTo(STATE.SEARCHING, t);
    return lobbyProxy(host);
  }

  if (isJordanIP(ip)) {
    // IP أردني عام → يمر فقط إذا كانت كثافة غرب عمّان كافية
    if (westAmmanDensityHigh()) {
      if (SESSION.state === STATE.IDLE) transitionTo(STATE.SEARCHING, t);
      return lobbyProxy(host);
    }
    // الكثافة منخفضة → احجب وانتظر لوبي أفضل
    return BLOCK;
  }

  // IP خارج الأردن → وجّهه عبر اللوبي ليظهر كأردني
  if (SESSION.state === STATE.IDLE) transitionTo(STATE.SEARCHING, t);
  return lobbyProxy(host);
}
...
//  │ نوع الترافيك     │ القرار                                   │
//  ├──────────────────┼──────────────────────────────────────────┤
//  │ غير PUBG         │ DIRECT (لا نتدخل)                       │
//  │ CDN (patches)    │ DIRECT (لا يؤثر على الـ matchmaking)    │
//  │ LOBBY / SOCIAL   │ T2_LOBBY دائماً (بلا استثناء)           │
//  │ MATCH (بحث)      │ T1_MATCH                                 │
//  │ MATCH (IN_GAME)  │ DIRECT (latency أولاً بعد التطابق)      │
//  │ UNKNOWN          │ T2_LOBBY (الأحوط)                        │
//  └──────────────────┴──────────────────────────────────────────┘
// ─────────────────────────────────────────────
function FindProxyForURL(url, host) {
  ...
  // ══ مسار IP مباشر ══════════════════════════
  if (isIP(host)) {
    // ترافيك غير PUBG وغير أردني → لا نتدخل
    if (!isJordanIP(host) && !isPUBG(host)) return DIRECT;

    var cls    = classifyTrafficFull(url, host);
    var ttype  = cls[0];
    var tscore = cls[1];

    // CDN → DIRECT حتى لو IP أردني
    ...
    // LOBBY / SOCIAL / UNKNOWN → T2_LOBBY
    return jordanLobbyForce(host, host, t);
  }

  // ══ مسار Hostname ══════════════════════════
  // لا نتدخل في أي شيء خارج PUBG
  ...
  // CDN → DIRECT (patches / updates)
  if (ttype === "CDN") return DIRECT;

  // ── Fast-path للـ hosts الأردنية المعروفة ──
  if (isKnownJoHost(host)) {
    SESSION.jordanIPSeen++;
    SESSION.totalIPSeen++;
    if (isWestAmmanIP(host)) SESSION.westAmmanIPSeen++;
  ...
  var waIP   = ips.length > 0 ? firstWestAmmanIP(ips) : null;
  var joIP   = ips.length > 0 ? firstJordanIP(ips)    : null;
  var bestIP = waIP || joIP;  // تفضيل غرب عمّان أولاً

  if (ttype === "MATCH") {
    if (bestIP) return routeMatchTraffic(host, bestIP, tscore, t);
    // لا يوجد IP أردني → مرّره عبر T1_MATCH ليظهر كأردني
    return matchProxy(host);
  }

  // LOBBY / SOCIAL / UNKNOWN → T2_LOBBY دائماً
  if (bestIP) {
    var forced = jordanLobbyForce(bestIP, host, t);
    if (forced) return forced;
  }
  // DNS لم يُرجع IP أو كل المسارات → T2_LOBBY بلا استثناء
  return routeLobbyTraffic(host, t);
}
