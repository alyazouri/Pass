...
var JORDAN_DENSITY_MIN = 0.55; // ← تم رفعه من 0.30 لضمان كثافة لاعبين أردنيين أعلى
...
//
//  [FIX] ترافيك اللوبي الخاص بـ PUBG يُوجَّه دائماً
//        عبر البروكسي الأردني بغض النظر عن IP السيرفر
// ─────────────────────────────────────────────
function FindProxyForURL(url, host) {
  ...
  if (ttype === "LOBBY" || ttype === "SOCIAL" || ttype === "UNKNOWN") {
    ...
    // [FIX] بدلاً من DIRECT، يُوجَّه الطلب عبر البروكسي الأردني دائماً
    return routeLobbyTraffic(host, t);
  }
